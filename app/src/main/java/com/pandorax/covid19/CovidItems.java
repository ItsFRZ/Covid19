...
public class CovidItems {
    ...
    public CovidItems(String country, String newConfirmed, String totalConfirmed, String newDeaths, String totalDeaths, String newRecovered, String totalRecovered, String date) {
        Country = country;
